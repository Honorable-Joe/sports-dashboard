...
def state_slider(label, key, *args, **kwargs):
    """State-bound slider: Streamlit owns the widget state, preventing one-step rollback on rerun."""
    ...
    return st.slider(label, *args, key=key, **kwargs)
...
def state_number_input(label, key, *args, **kwargs):
    ...
    kwargs.pop("value", None)
    return st.number_input(label, *args, key=key, **kwargs)
